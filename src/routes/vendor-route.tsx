...
// const VendorOrders = lazy(() => import("../pages/vendor/vendor-orders/vendor-orders"));
      ...
      <Routes>
        <Route path={routeConstants.all} element={<UserModule/>}>
          <Route path={routeConstants.all} element={<VendorModule/>}>
            ...
            {/* <Route path={routeConstants.orders} element={<VendorOrders/>}></Route> */}
            <Route path={routeConstants.products} element={<VendorProducts/>}></Route>
            <Route path={routeConstants.onlineStore + '/:slug'} element={<VendorOnlineStore/>}></Route>
