...
const SettingsOtpModal = (props: any) => {
  ...
  const confirmSettingsOtp = (values: any, controls: any) => {
      ...
      <div className={"modal-container mid-small no-pad"}>
        <div className="modal-content">
          ...
          <div>
            ...
            onSubmit={(values, controls) => confirmSettingsOtp(values, controls)}
                      ...
                      otp: string,
                        ...
                        return (
                            <form action="" onSubmit={handleSubmit}>
                                <h4 className="pt-3 pb-2 mb-2 px-4 increased">
                                  Settings
                                </h4>
                                <div style={{padding: '20px', borderTop: '1px solid #ddd'}}>
                                  <div className='styled-form2 w90-fl'>
                                      <p className="max300 reduced-soft">Enter OTP sent to your email to confirm this change</p>
                                  ...
                                  <p className="my-3 reduced">
                                    Vendu Admin would have to review this request and approve it. This will happen in 1-2 business days
                                  </p>
                                </div>
